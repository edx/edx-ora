...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.skip_basic_checks'
        db.add_column('controller_submission', 'skip_basic_checks',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.skip_basic_checks'
        db.delete_column('controller_submission', 'skip_basic_checks')
