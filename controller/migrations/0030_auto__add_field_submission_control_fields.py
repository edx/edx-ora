...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.control_fields'
        db.add_column('controller_submission', 'control_fields',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.control_fields'
        db.delete_column('controller_submission', 'control_fields')
