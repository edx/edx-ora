...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Message', fields ['originator', 'message', 'grader']
        db.create_unique('controller_message', ['originator', 'message', 'grader_id'])

        # Adding unique constraint on 'Submission', fields ['xqueue_submission_id', 'student_response', 'location', 'student_id']
        db.create_unique('controller_submission', ['xqueue_submission_id', 'student_response', 'location', 'student_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Submission', fields ['xqueue_submission_id', 'student_response', 'location', 'student_id']
        db.delete_unique('controller_submission', ['xqueue_submission_id', 'student_response', 'location', 'student_id'])

        # Removing unique constraint on 'Message', fields ['originator', 'message', 'grader']
        db.delete_unique('controller_message', ['originator', 'message', 'grader_id'])
    ...
    models = {
        ...
        'controller.message': {
            'Meta': {'unique_together': "(('grader', 'message', 'originator'),)", 'object_name': 'Message'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        'controller.submission': {
            'Meta': {'unique_together': "(('student_response', 'student_id', 'location', 'xqueue_submission_id'),)", 'object_name': 'Submission'},
