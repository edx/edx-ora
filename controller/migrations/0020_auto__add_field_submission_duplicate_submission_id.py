...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.duplicate_submission_id'
        db.add_column('controller_submission', 'duplicate_submission_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.duplicate_submission_id'
        db.delete_column('controller_submission', 'duplicate_submission_id')
