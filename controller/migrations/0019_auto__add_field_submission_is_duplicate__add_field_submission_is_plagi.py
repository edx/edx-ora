...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.is_duplicate'
        db.add_column('controller_submission', 'is_duplicate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Submission.is_plagiarized'
        db.add_column('controller_submission', 'is_plagiarized',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.is_duplicate'
        db.delete_column('controller_submission', 'is_duplicate')

        # Deleting field 'Submission.is_plagiarized'
        db.delete_column('controller_submission', 'is_plagiarized')
