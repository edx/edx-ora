...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RubricOption.rubric_item'
        db.add_column('controller_rubricoption', 'rubric_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['controller.RubricItem']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RubricOption.rubric_item'
        db.delete_column('controller_rubricoption', 'rubric_item_id')
