...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('controller_rubricoption', (
            ...
            ('points', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2)),
            ('short_text', self.gf('django.db.models.fields.CharField')(default='', max_length=1024)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('item_number', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('controller', ['RubricOption'])


    def backwards(self, orm):
        # Deleting model 'RubricOption'
        db.delete_table('controller_rubricoption')
