...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rubric.finished_scoring'
        db.add_column('controller_rubric', 'finished_scoring',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rubric.finished_scoring'
        db.delete_column('controller_rubric', 'finished_scoring')
