...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Rubric.submission'
        db.delete_column('controller_rubric', 'submission_id')

        # Adding field 'Rubric.grader'
        db.add_column('controller_rubric', 'grader',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['controller.Grader']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Rubric.submission'
        db.add_column('controller_rubric', 'submission',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['controller.Grader']),
                      keep_default=False)

        # Deleting field 'Rubric.grader'
        db.delete_column('controller_rubric', 'grader_id')
