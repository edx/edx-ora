...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.preferred_grader_type'
        db.add_column('controller_submission', 'preferred_grader_type',
                      self.gf('django.db.models.fields.CharField')(default='NA', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.preferred_grader_type'
        db.delete_column('controller_submission', 'preferred_grader_type')
