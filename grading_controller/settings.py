...
TIME_BETWEEN_XQUEUE_PULLS = 60 #seconds.  Time between pull_from_xqueue checking to see if new submissions are on queue.
...
TIME_BETWEEN_ML_GRADER_CHECKS= 60 # seconds.  Time between ML grader checking to see if models need to be made.
