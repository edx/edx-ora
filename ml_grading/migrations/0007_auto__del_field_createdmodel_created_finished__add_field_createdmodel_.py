...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CreatedModel.creation_finished'
        db.add_column('ml_grading_createdmodel', 'creation_finished',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CreatedModel.creation_finished'
        db.delete_column('ml_grading_createdmodel', 'creation_finished')
    ...
    models = {
        'ml_grading.createdmodel': {
            ...
            'creation_finished': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
