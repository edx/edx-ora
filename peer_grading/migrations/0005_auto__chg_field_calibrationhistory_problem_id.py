...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CalibrationHistory.problem_id'
        db.alter_column('peer_grading_calibrationhistory', 'problem_id', self.gf('django.db.models.fields.CharField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'CalibrationHistory.problem_id'
        db.alter_column('peer_grading_calibrationhistory', 'problem_id', self.gf('django.db.models.fields.CharField')(max_length=128))
