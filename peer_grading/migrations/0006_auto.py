...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'CalibrationHistory', fields ['student_id']
        db.create_index('peer_grading_calibrationhistory', ['student_id'])

        # Adding index on 'CalibrationHistory', fields ['location']
        db.create_index('peer_grading_calibrationhistory', ['location'])


    def backwards(self, orm):
        # Removing index on 'CalibrationHistory', fields ['location']
        db.delete_index('peer_grading_calibrationhistory', ['location'])

        # Removing index on 'CalibrationHistory', fields ['student_id']
        db.delete_index('peer_grading_calibrationhistory', ['student_id'])
